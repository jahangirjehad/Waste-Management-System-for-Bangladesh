...
import 'package:maps_app/Controller/assets_to_bytes.dart';
import 'package:maps_app/Model/map_markers.dart';
import 'package:maps_app/View/google_map/widgets/back_to_menu.dart';
import 'package:maps_app/View/google_map/widgets/button_center_map_on_the_marker.dart';
import 'package:maps_app/View/google_map/widgets/list_details.dart';
import 'package:maps_app/View/google_map/widgets/page_indicator.dart';
          ...
          onTap: () {
            ...
            setState(() {
              mapController.animateCamera(CameraUpdate.newCameraPosition(
                  CameraPosition(target: mapItem.location, zoom: 17)));
      ...
      body: Stack(
        children: [
          _currentPosition == null
              ...
              : GoogleMap(
                  ...
                  initialCameraPosition: const CameraPosition(
                    target: LatLng(22.4787345, 91.7942796),
                    zoom: 10,
                  ),
          ...
          ButtonCenterMapOnTheMarker(
            onPressed: () {
              // print('check map jahangir');
              mapController.animateCamera(CameraUpdate.newCameraPosition(
                  CameraPosition(
                      target: mapMarkers[selectedMarker].location, zoom: 10)));
            },
          ),
          PageIndicator(
          ...
          ListDetails(
            ...
            onPressedGoTo: (item) {
              //print('jahangir: ${item}');
              mapController.animateCamera(CameraUpdate.newCameraPosition(
                  CameraPosition(target: item.location, zoom: 20)));
            },
            onPressedCall: () {},
          ),
        ],
